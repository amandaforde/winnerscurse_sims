...
results_nsig <- data.frame(Scenario=c(1:24),n_samples=c(rep(c("30,000","300,000"),12)),results_nsig_5e_8[3:5], nsig_5e_8=round(results_nsig_5e_8$n_sig,2), nsig_5e_8_sd=round(results_nsig_5e_8$n_sig_sd,3), pb58 = round(results_nsig_5e_8$prop_bias,4), pb58sd=round(results_nsig_5e_8$prop_bias_sd,4), nsig_5e_4=round(results_nsig_5e_4$n_sig,2), nsig_5e_4_sd=round(results_nsig_5e_4$n_sig_sd,3), pb54 = round(results_nsig_5e_4$prop_bias,4), pb54sd=round(results_nsig_5e_4$prop_bias_sd,4))
...
full_width = FALSE,position="center") %>%
  ...
  column_spec(5,background="#FDF2E9") %>%
  column_spec(7, background = "#F5F5F5", italic=TRUE) %>%
  ...
  scroll_box(width = "98%", height = "300px")
```
...
ggplot(out,aes(x=z,y=bias)) + xlim(-6, 6) + geom_point(size=1) + xlab("z") +
  ylab("bias: beta_hat - true_beta") + ggtitle("Scenario 1", subtitle="n_samples=30,000   h2=0.3   prop_effect=0.01   S=-1") +  theme_classic() + geom_vline(xintercept=qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) +
...
ggplot(out,aes(x=z,y=bias)) + geom_point(size=1) + xlab("z") +
  ylab("bias: beta_hat - true_beta") + ggtitle("Scenario 2", subtitle="n_samples=300,000   h2=0.3   prop_effect=0.01   S=-1") +  theme_classic() + geom_vline(xintercept=qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) +
  geom_vline(xintercept=qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) + geom_hline(yintercept=0) +
  theme(
...
out$bias <- out$beta - ss$true_beta
ggplot(out,aes(x=z,y=bias)) + geom_point(size=1) + xlab("z") +
  ylab("bias: beta_hat - true_beta") + ggtitle("Scenario 3", subtitle="n_samples=30,000   h2=0.8   prop_effect=0.01   S=-1") +  theme_classic() + geom_vline(xintercept=qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) +
...
out$bias <- out$beta - ss$true_beta
ggplot(out,aes(x=z,y=bias)) + geom_point(size=1) + xlab("z") +
  ylab("bias: beta_hat - true_beta") + ggtitle("Scenario 4", subtitle="n_samples=300,000   h2=0.8   prop_effect=0.01   S=-1") +  theme_classic() + geom_vline(xintercept=qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) +
  geom_vline(xintercept=qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) +
  geom_hline(yintercept=0) +
  theme(
...
ggplot(out,aes(x=z,y=bias)) + geom_point(size=1) + xlab("z") +
  ylab("bias: beta_hat - true_beta") + ggtitle("Scenario 5", subtitle="n_samples=30,000   h2=0.3   prop_effect=0.001   S=-1") +  theme_classic() + geom_vline(xintercept=qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) +
geom_vline(xintercept=qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) +
  geom_hline(yintercept=0) +
  theme(
...
out$bias <- out$beta - ss$true_beta
ggplot(out,aes(x=z,y=bias)) + geom_point(size=1) + xlab("z") +
  ylab("bias: beta_hat - true_beta") + ggtitle("Scenario 6", subtitle="n_samples=300,000   h2=0.3   prop_effect=0.001   S=-1") +  theme_classic() + geom_vline(xintercept=qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) +
geom_vline(xintercept=qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) +
  geom_hline(yintercept=0) +
  theme(
...
out$bias <- out$beta - ss$true_beta
ggplot(out,aes(x=z,y=bias)) + geom_point(size=1) + xlab("z") +
  ylab("bias: beta_hat - true_beta") + ggtitle("Scenario 7", subtitle="n_samples=30,000   h2=0.8   prop_effect=0.001   S=-1") +  theme_classic() + geom_vline(xintercept=qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) +
geom_vline(xintercept=qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) +
  geom_hline(yintercept=0) +
  theme(
...
out$bias <- out$beta - ss$true_beta
ggplot(out,aes(x=z,y=bias)) + geom_point(size=1) + xlab("z") +
  ylab("bias: beta_hat - true_beta") + ggtitle("Scenario 8", subtitle="n_samples=300,000   h2=0.8   prop_effect=0.001   S=-1") +  theme_classic() + geom_vline(xintercept=qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) +
geom_vline(xintercept=qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) +
  geom_hline(yintercept=0) +
  theme(
...
ggplot(out,aes(x=z,y=bias)) + xlim(-6, 6) + geom_point(size=1) + xlab("z") +
  ylab("bias: beta_hat - true_beta") + ggtitle("Scenario 9", subtitle="n_samples=30,000   h2=0.3   prop_effect=0.01   S=0") +  theme_classic() + geom_vline(xintercept=qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) +
geom_vline(xintercept=qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) +
  geom_hline(yintercept=0) +
  theme(
    plot.title = element_text(hjust = 0.5, face="bold", colour=col[1]),
...
out$bias <- out$beta - ss$true_beta
ggplot(out,aes(x=z,y=bias)) + geom_point(size=1) + xlab("z") +
  ylab("bias: beta_hat - true_beta") + ggtitle("Scenario 10", subtitle="n_samples=300,000   h2=0.3   prop_effect=0.01   S=0") +  theme_classic() + geom_vline(xintercept=qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) +
  geom_vline(xintercept=qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) +
  geom_hline(yintercept=0) +
  theme(
    plot.title = element_text(hjust = 0.5, face="bold", colour=col[2]),
...
out$bias <- out$beta - ss$true_beta
ggplot(out,aes(x=z,y=bias)) + geom_point(size=1) + xlab("z") +
  ylab("bias: beta_hat - true_beta") + ggtitle("Scenario 11", subtitle="n_samples=30,000   h2=0.8   prop_effect=0.01   S=0") +  theme_classic() + geom_vline(xintercept=qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) +
  geom_vline(xintercept=qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) +
  geom_hline(yintercept=0) +
  theme(
    plot.title = element_text(hjust = 0.5, face="bold", colour=col[3]),
...
out$bias <- out$beta - ss$true_beta
ggplot(out,aes(x=z,y=bias)) + geom_point(size=1) + xlab("z") +
  ylab("bias: beta_hat - true_beta") + ggtitle("Scenario 12", subtitle="n_samples=300,000   h2=0.8   prop_effect=0.01   S=0") +  theme_classic() + geom_vline(xintercept=qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) +
  geom_vline(xintercept=qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) +
  geom_hline(yintercept=0) +
  theme(
    plot.title = element_text(hjust = 0.5, face="bold", colour=col[4]),
...
ggplot(out,aes(x=z,y=bias)) + geom_point(size=1) + xlab("z") +
  ylab("bias: beta_hat - true_beta") + ggtitle("Scenario 13", subtitle="n_samples=30,000   h2=0.3   prop_effect=0.001   S=0") +  theme_classic() + geom_vline(xintercept=qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) +
geom_vline(xintercept=qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) +
  geom_hline(yintercept=0) +
  theme(
    plot.title = element_text(hjust = 0.5, face="bold", colour=col[5]),
...
out$bias <- out$beta - ss$true_beta
ggplot(out,aes(x=z,y=bias)) + geom_point(size=1) + xlab("z") +
  ylab("bias: beta_hat - true_beta") + ggtitle("Scenario 14", subtitle="n_samples=300,000   h2=0.3   prop_effect=0.001   S=0") +  theme_classic() + geom_vline(xintercept=qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) +
geom_vline(xintercept=qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) +
  geom_hline(yintercept=0) +
  theme(
    plot.title = element_text(hjust = 0.5, face="bold", colour=col[6]),
...
out$bias <- out$beta - ss$true_beta
ggplot(out,aes(x=z,y=bias)) + geom_point(size=1) + xlab("z") +
  ylab("bias: beta_hat - true_beta") + ggtitle("Scenario 15", subtitle="n_samples=30,000   h2=0.8   prop_effect=0.001   S=0") +  theme_classic() + geom_vline(xintercept=qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) +
geom_vline(xintercept=qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) +
  geom_hline(yintercept=0) +
  theme(
    plot.title = element_text(hjust = 0.5, face="bold", colour=col[7]),
...
out$bias <- out$beta - ss$true_beta
ggplot(out,aes(x=z,y=bias)) + geom_point(size=1) + xlab("z") +
  ylab("bias: beta_hat - true_beta") + ggtitle("Scenario 16", subtitle="n_samples=300,000   h2=0.8   prop_effect=0.001   S=0") +  theme_classic() + geom_vline(xintercept=qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) +
geom_vline(xintercept=qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) +
  geom_hline(yintercept=0) +
  theme(
    plot.title = element_text(hjust = 0.5, face="bold", colour=col[8]),
...
ggplot(out,aes(x=z,y=bias)) + xlim(-6, 6) + geom_point(size=1) + xlab("z") +
  ylab("bias: beta_hat - true_beta") + ggtitle("Scenario 17", subtitle="n_samples=30,000   h2=0.3   prop_effect=0.01   S=1") +  theme_classic() + geom_vline(xintercept=qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) +
geom_vline(xintercept=qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) +
  geom_hline(yintercept=0) +
  theme(
    plot.title = element_text(hjust = 0.5, face="bold", colour=col[1]),
...
out$bias <- out$beta - ss$true_beta
ggplot(out,aes(x=z,y=bias)) + geom_point(size=1) + xlab("z") +
  ylab("bias: beta_hat - true_beta") + ggtitle("Scenario 18", subtitle="n_samples=300,000   h2=0.3   prop_effect=0.01   S=1") +  theme_classic() + geom_vline(xintercept=qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) +
  geom_vline(xintercept=qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) +
  geom_hline(yintercept=0) +
  theme(
    plot.title = element_text(hjust = 0.5, face="bold", colour=col[2]),
...
out$bias <- out$beta - ss$true_beta
ggplot(out,aes(x=z,y=bias)) + geom_point(size=1) + xlab("z") +
  ylab("bias: beta_hat - true_beta") + ggtitle("Scenario 19", subtitle="n_samples=30,000   h2=0.8   prop_effect=0.01   S=1") +  theme_classic() + geom_vline(xintercept=qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) +
  geom_vline(xintercept=qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) +
  geom_hline(yintercept=0) +
  theme(
    plot.title = element_text(hjust = 0.5, face="bold", colour=col[3]),
...
out$bias <- out$beta - ss$true_beta
ggplot(out,aes(x=z,y=bias)) + geom_point(size=1) + xlab("z") +
  ylab("bias: beta_hat - true_beta") + ggtitle("Scenario 20", subtitle="n_samples=300,000   h2=0.8   prop_effect=0.01   S=1") +  theme_classic() + geom_vline(xintercept=qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) +
  geom_vline(xintercept=qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) +
  geom_hline(yintercept=0) +
  theme(
    plot.title = element_text(hjust = 0.5, face="bold", colour=col[4]),
...
ggplot(out,aes(x=z,y=bias)) + geom_point(size=1) + xlab("z") +
  ylab("bias: beta_hat - true_beta") + ggtitle("Scenario 21", subtitle="n_samples=30,000   h2=0.3   prop_effect=0.001   S=1") +  theme_classic() + geom_vline(xintercept=qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) +
geom_vline(xintercept=qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) +
  geom_hline(yintercept=0) +
  theme(
    plot.title = element_text(hjust = 0.5, face="bold", colour=col[5]),
...
out$bias <- out$beta - ss$true_beta
ggplot(out,aes(x=z,y=bias)) + geom_point(size=1) + xlab("z") +
  ylab("bias: beta_hat - true_beta") + ggtitle("Scenario 22", subtitle="n_samples=300,000   h2=0.3   prop_effect=0.001   S=1") +  theme_classic() + geom_vline(xintercept=qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) +
geom_vline(xintercept=qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) +
  geom_hline(yintercept=0) +
  theme(
    plot.title = element_text(hjust = 0.5, face="bold", colour=col[6]),
...
out$bias <- out$beta - ss$true_beta
ggplot(out,aes(x=z,y=bias)) + geom_point(size=1) + xlab("z") +
  ylab("bias: beta_hat - true_beta") + ggtitle("Scenario 23", subtitle="n_samples=30,000   h2=0.8   prop_effect=0.001   S=1") +  theme_classic() + geom_vline(xintercept=qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) +
geom_vline(xintercept=qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) +
  geom_hline(yintercept=0) +
  theme(
    plot.title = element_text(hjust = 0.5, face="bold", colour=col[7]),
...
out$bias <- out$beta - ss$true_beta
ggplot(out,aes(x=z,y=bias)) + geom_point(size=1) + xlab("z") +
  ylab("bias: beta_hat - true_beta") + ggtitle("Scenario 24", subtitle="n_samples=300,000   h2=0.8   prop_effect=0.001   S=1") +  theme_classic() + geom_vline(xintercept=qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-8)/2), colour="red", linetype="dashed",size=1) +
geom_vline(xintercept=qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) + geom_vline(xintercept=-qnorm(1-(5e-4)/2), colour="darkred", linetype="dashed",size=1) +
  geom_hline(yintercept=0) +
  theme(
    plot.title = element_text(hjust = 0.5, face="bold", colour=col[8]),
...
norm_5e_8_flb_10sim <- read.csv("results/norm_5e-8_flb_10sim.csv")
results_flb <- data.frame(Scenario=c(1:24),n_samples = c(rep(c("30,000","300,000"),12)), h2 = norm_5e_8_flb_10sim$h2[1:24], prop_effect = norm_5e_8_flb_10sim$prop_effect[1:24], S= norm_5e_8_flb_10sim$S[1:24], EB = round(norm_5e_8_flb_10sim$results[1:24],4), FIQT = round(norm_5e_8_flb_10sim$results[(1+24):(24+24)],4), BR = round(norm_5e_8_flb_10sim$results[(1+2*24):(24+2*24)],4), cl1 = round(norm_5e_8_flb_10sim$results[(1+3*24):(24+3*24)],4), cl2 = round(norm_5e_8_flb_10sim$results[(1+4*24):(24+4*24)],4), cl3 = round(norm_5e_8_flb_10sim$results[(1+5*24):(24+5*24)],4))
...
full_width = FALSE,position="center") %>%
  ...
  column_spec(5,background="#EAF2F8") %>%
...
## plot results
norm_5e_8_flb_10sim$scenario <- c(rep(c(1:24),6))
norm_5e_8_flb_10sim$scenario <- factor(norm_5e_8_flb_10sim$scenario)

par(mar = c(4, 4, .1, .1))


data_negS <- norm_5e_8_flb_10sim[which(norm_5e_8_flb_10sim$S==-1),]
data_negSa <- data_negS[data_negS$scenario == 1 | data_negS$scenario == 2 |data_negS$scenario == 3 |data_negS$scenario == 4,]
ggplot(data_negSa,aes(x=scenario,y=results,colour=method)) + geom_point(position=position_dodge(0.35),size=4.5,aes(shape=method, color=method)) + ggtitle("Scenarios 1 - 4", subtitle="S=-1   prop_effect=0.01")  + scale_shape_manual(values=c(6,18,10,20,15,17)) + scale_color_manual(values=c(col[1],col[2],col[8],col[4],col[5],col[6]))  +
  ylab(expression(paste("Fraction of sig. SNPs", italic(" less "), "biased"))) + theme_classic() + xlab("") + geom_errorbar(aes(ymin=results-res_error, ymax=results+res_error), width=.25,position=position_dodge(0.35)) + geom_hline(yintercept=0.5, colour="black") + theme(axis.text.x = element_text(face ="bold",size=rel(1.25)),legend.title = element_blank(),legend.box.background = element_rect(colour = "black"),legend.spacing.y = unit(0, "mm"), legend.background=element_blank(), legend.text = element_text(size=10), plot.title = element_text(hjust = 0.5, face="bold", colour='#154360'),plot.subtitle = element_text(hjust = 0.5, face="italic"))


data_negSb <- data_negS[data_negS$scenario == 5 | data_negS$scenario == 6 |data_negS$scenario == 7 |data_negS$scenario == 8,]
ggplot(data_negSb,aes(x=scenario,y=results,colour=method)) + geom_point(position=position_dodge(0.35),size=4.5,aes(shape=method, color=method)) + ggtitle("Scenarios 5 - 8", subtitle="S=-1   prop_effect=0.001") + scale_shape_manual(values=c(6,18,10,20,15,17)) + scale_color_manual(values=c(col[1],col[2],col[8],col[4],col[5],col[6])) + xlab("") +
  ylab(expression(paste("Fraction of sig. SNPs", italic(" less "), "biased"))) + theme_classic() + geom_errorbar(aes(ymin=results-res_error, ymax=results+res_error), width=.25,position=position_dodge(0.35)) + geom_hline(yintercept=0.5, colour="black") + theme(axis.text.x = element_text(face ="bold",size=rel(1.25)),legend.title = element_blank(),legend.box.background = element_rect(colour = "black"),legend.spacing.y = unit(0, "mm"), legend.background=element_blank(), legend.text = element_text(size=10),plot.title = element_text(hjust = 0.5, face="bold", colour='#154360'),plot.subtitle = element_text(hjust = 0.5, face="italic"))


data_neutralS <- norm_5e_8_flb_10sim[which(norm_5e_8_flb_10sim$S==0),]
...
```{r,echo=FALSE}
norm_5e_8_mse_10sim <- read.csv("results/norm_5e-8_mse-change2_10sim.csv")
results_mse <- data.frame(Scenario=c(1:24),n_samples = c(rep(c("30,000","300,000"),12)), h2 = norm_5e_8_mse_10sim$h2[1:24], prop_effect = norm_5e_8_mse_10sim$prop_effect[1:24], S= norm_5e_8_mse_10sim$S[1:24], EB = round(norm_5e_8_mse_10sim$results[1:24],6), FIQT = round(norm_5e_8_mse_10sim$results[(1+24):(24+24)],6), BR = round(norm_5e_8_mse_10sim$results[(1+2*24):(24+2*24)],6), cl1 = round(norm_5e_8_mse_10sim$results[(1+3*24):(24+3*24)],6), cl2 = round(norm_5e_8_mse_10sim$results[(1+4*24):(24+4*24)],6), cl3 = round(norm_5e_8_mse_10sim$results[(1+5*24):(24+5*24)],6))
...
full_width = FALSE,position="center") %>%
  ...
  column_spec(5,background="#FEF9E7") %>%
...
## plot results
norm_5e_8_mse_10sim$scenario <- c(rep(c(1:24),6))
norm_5e_8_mse_10sim$scenario <- factor(norm_5e_8_mse_10sim$scenario)

par(mar = c(4, 4, .1, .1))


data_negS <- norm_5e_8_mse_10sim[which(norm_5e_8_mse_10sim$S==-1),]
data_negSa <- data_negS[data_negS$scenario == 1 | data_negS$scenario == 2 |data_negS$scenario == 3 |data_negS$scenario == 4,]
ggplot(data_negSa,aes(x=scenario,y=results,colour=method)) + geom_point(position=position_dodge(0.35),size=4.5,aes(shape=method, color=method)) + ggtitle("Scenarios 1 - 4", subtitle="S=-1   prop_effect=0.01")  + scale_shape_manual(values=c(6,18,10,20,15,17)) + scale_color_manual(values=c(col[1],col[2],col[8],col[4],col[5],col[6]))  +
  ylab(expression(paste(italic("Change "), "in MSE of sig. SNPs"))) + theme_classic() + xlab("") + geom_errorbar(aes(ymin=results-res_error, ymax=results+res_error), width=.25,position=position_dodge(0.35)) + geom_hline(yintercept=0, colour="black") + theme(axis.text.x = element_text(face ="bold",size=rel(1.25)),legend.title = element_blank(),legend.box.background = element_rect(colour = "black"),legend.spacing.y = unit(0, "mm"), legend.background=element_blank(), legend.text = element_text(size=10), plot.title = element_text(hjust = 0.5, face="bold", colour='#7D6608'),plot.subtitle = element_text(hjust = 0.5, face="italic"))


data_negSb <- data_negS[data_negS$scenario == 5 | data_negS$scenario == 6 |data_negS$scenario == 7 |data_negS$scenario == 8,]
ggplot(data_negSb,aes(x=scenario,y=results,colour=method)) + geom_point(position=position_dodge(0.35),size=4.5,aes(shape=method, color=method)) + ggtitle("Scenarios 5 - 8", subtitle="S=-1   prop_effect=0.001") + scale_shape_manual(values=c(6,18,10,20,15,17)) + scale_color_manual(values=c(col[1],col[2],col[8],col[4],col[5],col[6])) + xlab("") +
  ylab(expression(paste(italic("Change "), "in MSE of sig. SNPs"))) + theme_classic() + geom_errorbar(aes(ymin=results-res_error, ymax=results+res_error), width=.25,position=position_dodge(0.35)) + geom_hline(yintercept=0, colour="black") + theme(axis.text.x = element_text(face ="bold",size=rel(1.25)),legend.title = element_blank(),legend.box.background = element_rect(colour = "black"),legend.spacing.y = unit(0, "mm"), legend.background=element_blank(), legend.text = element_text(size=10),plot.title = element_text(hjust = 0.5, face="bold", colour='#7D6608'),plot.subtitle = element_text(hjust = 0.5, face="italic"))


data_neutralS <- norm_5e_8_mse_10sim[which(norm_5e_8_mse_10sim$S==0),]
data_neutralSa <- data_neutralS[data_neutralS$scenario == 9 | data_neutralS$scenario == 10 |data_neutralS$scenario == 11 |data_neutralS$scenario == 12,]
ggplot(data_neutralSa,aes(x=scenario,y=results,colour=method)) + geom_point(position=position_dodge(0.35),size=4.5,aes(shape=method, color=method)) + scale_shape_manual(values=c(6,18,10,20,15,17)) + scale_color_manual(values=c(col[1],col[2],col[8],col[4],col[5],col[6])) + xlab("") + ggtitle("Scenarios 9 - 12", subtitle="S=0   prop_effect=0.01") +
  ylab(expression(paste(italic("Change "), "in MSE of sig. SNPs"))) + theme_classic() + geom_errorbar(aes(ymin=results-res_error, ymax=results+res_error), width=.25,position=position_dodge(0.35)) + geom_hline(yintercept=0, colour="black") +  theme(axis.text.x = element_text(face = "bold",size=rel(1.25)),legend.title = element_blank(),legend.box.background = element_rect(colour = "black"),legend.spacing.y = unit(0, "mm"), legend.background=element_blank(), legend.text = element_text(size=10),plot.title = element_text(hjust = 0.5, face="bold", colour='#7D6608'),plot.subtitle = element_text(hjust = 0.5, face="italic"))
...
data_posS <- norm_5e_8_mse_10sim[which(norm_5e_8_mse_10sim$S==1),]
data_posSa <- data_posS[data_posS$scenario == 17 | data_posS$scenario == 18 |data_posS$scenario == 19 |data_posS$scenario == 20,]
ggplot(data_posSa,aes(x=scenario,y=results,colour=method)) + geom_point(position=position_dodge(0.35),size=4.5,aes(shape=method, color=method)) + ggtitle("Scenarios 17 - 20", subtitle="S=1   prop_effect=0.01") + scale_shape_manual(values=c(6,18,10,20,15,17)) + scale_color_manual(values=c(col[1],col[2],col[8],col[4],col[5],col[6])) + xlab("") +
  ylab(expression(paste(italic("Change "), "in MSE of sig. SNPs"))) + theme_classic() + geom_errorbar(aes(ymin=results-res_error, ymax=results+res_error), width=.25,position=position_dodge(0.35)) + geom_hline(yintercept=0, colour="black") +  theme(axis.text.x = element_text(face = "bold",size=rel(1.25)),legend.title = element_blank(),legend.box.background = element_rect(colour = "black"),legend.spacing.y = unit(0, "mm"), legend.background=element_blank(), legend.text = element_text(size=10),plot.title = element_text(hjust = 0.5, face="bold", colour='#7D6608'),plot.subtitle = element_text(hjust = 0.5, face="italic"))
...
```{r,echo=FALSE}
norm_5e_8_mse_10sim <- read.csv("results/norm_5e-8_mse-change_10sim.csv")
results_mse <- data.frame(Scenario=c(1:24),n_samples = c(rep(c("30,000","300,000"),12)), h2 = norm_5e_8_mse_10sim$h2[1:24], prop_effect = norm_5e_8_mse_10sim$prop_effect[1:24], S= norm_5e_8_mse_10sim$S[1:24], EB = round(norm_5e_8_mse_10sim$results[1:24],4), FIQT = round(norm_5e_8_mse_10sim$results[(1+24):(24+24)],4), BR = round(norm_5e_8_mse_10sim$results[(1+2*24):(24+2*24)],4), cl1 = round(norm_5e_8_mse_10sim$results[(1+3*24):(24+3*24)],4), cl2 = round(norm_5e_8_mse_10sim$results[(1+4*24):(24+4*24)],4), cl3 = round(norm_5e_8_mse_10sim$results[(1+5*24):(24+5*24)],4))
...
full_width = FALSE,position="center") %>%
  ...
  column_spec(5,background="#E9F7EF") %>%
  scroll_box(width = "70%", height = "300px")
```
...
data_negSa <- data_negS[data_negS$scenario == 1 | data_negS$scenario == 2 |data_negS$scenario == 3 |data_negS$scenario == 4,]
ggplot(data_negSa,aes(x=scenario,y=results,colour=method)) + geom_point(position=position_dodge(0.35),size=4.5,aes(shape=method, color=method)) + ggtitle("Scenarios 1 - 4", subtitle="S=-1   prop_effect=0.01")  + scale_shape_manual(values=c(6,18,10,20,15,17)) + scale_color_manual(values=c(col[1],col[2],col[8],col[4],col[5],col[6]))  +
  ylab(expression(paste("Rel.", italic(" change "), "in MSE of sig. SNPs"))) + theme_classic() + xlab("") + geom_errorbar(aes(ymin=results-res_error, ymax=results+res_error), width=.25,position=position_dodge(0.35)) + geom_hline(yintercept=0, colour="black") + theme(axis.text.x = element_text(face ="bold",size=rel(1.25)),legend.title = element_blank(),legend.box.background = element_rect(colour = "black"),legend.spacing.y = unit(0, "mm"), legend.background=element_blank(), legend.text = element_text(size=10), plot.title = element_text(hjust = 0.5, face="bold", colour='#145A32'),plot.subtitle = element_text(hjust = 0.5, face="italic")) 


data_negSb <- data_negS[data_negS$scenario == 5 | data_negS$scenario == 6 |data_negS$scenario == 7 |data_negS$scenario == 8,]
ggplot(data_negSb,aes(x=scenario,y=results,colour=method)) + geom_point(position=position_dodge(0.35),size=4.5,aes(shape=method, color=method)) + ggtitle("Scenarios 5 - 8", subtitle="S=-1   prop_effect=0.001") + scale_shape_manual(values=c(6,18,10,20,15,17)) + scale_color_manual(values=c(col[1],col[2],col[8],col[4],col[5],col[6])) + xlab("") +
  ylab(expression(paste("Rel.", italic(" change "), "in MSE of sig. SNPs"))) + theme_classic() + geom_errorbar(aes(ymin=results-res_error, ymax=results+res_error), width=.25,position=position_dodge(0.35)) + geom_hline(yintercept=0, colour="black") + theme(axis.text.x = element_text(face ="bold",size=rel(1.25)),legend.title = element_blank(),legend.box.background = element_rect(colour = "black"),legend.spacing.y = unit(0, "mm"), legend.background=element_blank(), legend.text = element_text(size=10),plot.title = element_text(hjust = 0.5, face="bold", colour='#145A32'),plot.subtitle = element_text(hjust = 0.5, face="italic")) 
...
norm_5e_4_flb_10sim <- read.csv("results/norm_5e-4_flb_10sim.csv")
results_flb2 <- data.frame(Scenario=c(1:24),n_samples = c(rep(c("30,000","300,000"),12)), h2 = norm_5e_4_flb_10sim$h2[1:24], prop_effect = norm_5e_4_flb_10sim$prop_effect[1:24], S= norm_5e_4_flb_10sim$S[1:24], EB = round(norm_5e_4_flb_10sim$results[1:24],4), FIQT = round(norm_5e_4_flb_10sim$results[(1+24):(24+24)],4), BR = round(norm_5e_4_flb_10sim$results[(1+2*24):(24+2*24)],4), cl1 = round(norm_5e_4_flb_10sim$results[(1+3*24):(24+3*24)],4), cl2 = round(norm_5e_4_flb_10sim$results[(1+4*24):(24+4*24)],4), cl3 = round(norm_5e_4_flb_10sim$results[(1+5*24):(24+5*24)],4))
...
full_width = FALSE,position="center") %>%
  ...
  column_spec(5,background="#F9EBEA") %>%
  scroll_box(width = "70%", height = "300px")
...
## plot results
norm_5e_4_flb_10sim$scenario <- c(rep(c(1:24),6))
norm_5e_4_flb_10sim$scenario <- factor(norm_5e_4_flb_10sim$scenario)

par(mar = c(4, 4, .1, .1))


data_negS <- norm_5e_4_flb_10sim[which(norm_5e_4_flb_10sim$S==-1),]
data_negSa <- data_negS[data_negS$scenario == 1 | data_negS$scenario == 2 |data_negS$scenario == 3 |data_negS$scenario == 4,]
ggplot(data_negSa,aes(x=scenario,y=results,colour=method)) + geom_point(position=position_dodge(0.35),size=4.5,aes(shape=method, color=method)) + ggtitle("Scenarios 1 - 4", subtitle="S=-1   prop_effect=0.01")  + scale_shape_manual(values=c(6,18,10,20,15,17)) + scale_color_manual(values=c(col[1],col[2],col[8],col[4],col[5],col[6]))  +
...
data_neutralS <- norm_5e_4_flb_10sim[which(norm_5e_4_flb_10sim$S==0),]
data_neutralSa <- data_neutralS[data_neutralS$scenario == 9 | data_neutralS$scenario == 10 |data_neutralS$scenario == 11 |data_neutralS$scenario == 12,]
ggplot(data_neutralSa,aes(x=scenario,y=results,colour=method)) + geom_point(position=position_dodge(0.35),size=4.5,aes(shape=method, color=method)) + scale_shape_manual(values=c(6,18,10,20,15,17)) + scale_color_manual(values=c(col[1],col[2],col[8],col[4],col[5],col[6])) + xlab("") + ggtitle("Scenarios 9 - 12", subtitle="S=0   prop_effect=0.01") +
  ylab(expression(paste("Fraction of sig. SNPs", italic(" less "), "biased"))) + theme_classic() + geom_errorbar(aes(ymin=results-res_error, ymax=results+res_error), width=.25,position=position_dodge(0.35)) + geom_hline(yintercept=0.5, colour="black") +  theme(axis.text.x = element_text(face = "bold",size=rel(1.25)),legend.title = element_blank(),legend.box.background = element_rect(colour = "black"),legend.spacing.y = unit(0, "mm"), legend.background=element_blank(), legend.text = element_text(size=10),plot.title = element_text(hjust = 0.5, face="bold", colour='#641E16'),plot.subtitle = element_text(hjust = 0.5, face="italic"))
...
data_posS <- norm_5e_4_flb_10sim[which(norm_5e_4_flb_10sim$S==1),]
data_posSa <- data_posS[data_posS$scenario == 17 | data_posS$scenario == 18 |data_posS$scenario == 19 |data_posS$scenario == 20,]
ggplot(data_posSa,aes(x=scenario,y=results,colour=method)) + geom_point(position=position_dodge(0.35),size=4.5,aes(shape=method, color=method)) + ggtitle("Scenarios 17 - 20", subtitle="S=1   prop_effect=0.01") + scale_shape_manual(values=c(6,18,10,20,15,17)) + scale_color_manual(values=c(col[1],col[2],col[8],col[4],col[5],col[6])) + xlab("") +
  ylab(expression(paste("Fraction of sig. SNPs", italic(" less "), "biased"))) + theme_classic() + geom_errorbar(aes(ymin=results-res_error, ymax=results+res_error), width=.25,position=position_dodge(0.35)) + geom_hline(yintercept=0.5, colour="black") +  theme(axis.text.x = element_text(face = "bold",size=rel(1.25)),legend.title = element_blank(),legend.box.background = element_rect(colour = "black"),legend.spacing.y = unit(0, "mm"), legend.background=element_blank(), legend.text = element_text(size=10),plot.title = element_text(hjust = 0.5, face="bold", colour='#641E16'),plot.subtitle = element_text(hjust = 0.5, face="italic"))
...
```{r,echo=FALSE}
norm_5e_4_mse_10sim <- read.csv("results/norm_5e-4_mse-change2_10sim.csv")
results_mse <- data.frame(Scenario=c(1:24),n_samples = c(rep(c("30,000","300,000"),12)), h2 = norm_5e_4_mse_10sim$h2[1:24], prop_effect = norm_5e_4_mse_10sim$prop_effect[1:24], S= norm_5e_4_mse_10sim$S[1:24], EB = round(norm_5e_4_mse_10sim$results[1:24],6), FIQT = round(norm_5e_4_mse_10sim$results[(1+24):(24+24)],6), BR = round(norm_5e_4_mse_10sim$results[(1+2*24):(24+2*24)],6), cl1 = round(norm_5e_4_mse_10sim$results[(1+3*24):(24+3*24)],6), cl2 = round(norm_5e_4_mse_10sim$results[(1+4*24):(24+4*24)],6), cl3 = round(norm_5e_4_mse_10sim$results[(1+5*24):(24+5*24)],6))
...
full_width = FALSE,position="center") %>%
  ...
  column_spec(5,background="#F4ECF7") %>%
  scroll_box(width = "80%", height = "300px")
```
...
## plot results
norm_5e_4_mse_10sim$scenario <- c(rep(c(1:24),6))
norm_5e_4_mse_10sim$scenario <- factor(norm_5e_4_mse_10sim$scenario)

par(mar = c(4, 4, .1, .1))


data_negS <- norm_5e_4_mse_10sim[which(norm_5e_4_mse_10sim$S==-1),]
data_negSa <- data_negS[data_negS$scenario == 1 | data_negS$scenario == 2 |data_negS$scenario == 3 |data_negS$scenario == 4,]
ggplot(data_negSa,aes(x=scenario,y=results,colour=method)) + geom_point(position=position_dodge(0.35),size=4.5,aes(shape=method, color=method)) + ggtitle("Scenarios 1 - 4", subtitle="S=-1   prop_effect=0.01")  + scale_shape_manual(values=c(6,18,10,20,15,17)) + scale_color_manual(values=c(col[1],col[2],col[8],col[4],col[5],col[6]))  +
...
data_neutralS <- norm_5e_4_mse_10sim[which(norm_5e_4_mse_10sim$S==0),]
data_neutralSa <- data_neutralS[data_neutralS$scenario == 9 | data_neutralS$scenario == 10 |data_neutralS$scenario == 11 |data_neutralS$scenario == 12,]
ggplot(data_neutralSa,aes(x=scenario,y=results,colour=method)) + geom_point(position=position_dodge(0.35),size=4.5,aes(shape=method, color=method)) + scale_shape_manual(values=c(6,18,10,20,15,17)) + scale_color_manual(values=c(col[1],col[2],col[8],col[4],col[5],col[6])) + xlab("") + ggtitle("Scenarios 9 - 12", subtitle="S=0   prop_effect=0.01") +
  ylab(expression(paste(italic("Change "), "in MSE of sig. SNPs"))) + theme_classic() + geom_errorbar(aes(ymin=results-res_error, ymax=results+res_error), width=.25,position=position_dodge(0.35)) + geom_hline(yintercept=0, colour="black") +  theme(axis.text.x = element_text(face = "bold",size=rel(1.25)),legend.title = element_blank(),legend.box.background = element_rect(colour = "black"),legend.spacing.y = unit(0, "mm"), legend.background=element_blank(), legend.text = element_text(size=10),plot.title = element_text(hjust = 0.5, face="bold", colour='#4A235A'),plot.subtitle = element_text(hjust = 0.5, face="italic"))
...
data_posS <- norm_5e_4_mse_10sim[which(norm_5e_4_mse_10sim$S==1),]
data_posSa <- data_posS[data_posS$scenario == 17 | data_posS$scenario == 18 |data_posS$scenario == 19 |data_posS$scenario == 20,]
ggplot(data_posSa,aes(x=scenario,y=results,colour=method)) + geom_point(position=position_dodge(0.35),size=4.5,aes(shape=method, color=method)) + ggtitle("Scenarios 17 - 20", subtitle="S=1   prop_effect=0.01") + scale_shape_manual(values=c(6,18,10,20,15,17)) + scale_color_manual(values=c(col[1],col[2],col[8],col[4],col[5],col[6])) + xlab("") +
  ylab(expression(paste(italic("Change "), "in MSE of sig. SNPs"))) + theme_classic() + geom_errorbar(aes(ymin=results-res_error, ymax=results+res_error), width=.25,position=position_dodge(0.35)) + geom_hline(yintercept=0, colour="black") +  theme(axis.text.x = element_text(face = "bold",size=rel(1.25)),legend.title = element_blank(),legend.box.background = element_rect(colour = "black"),legend.spacing.y = unit(0, "mm"), legend.background=element_blank(), legend.text = element_text(size=10),plot.title = element_text(hjust = 0.5, face="bold", colour='#4A235A'),plot.subtitle = element_text(hjust = 0.5, face="italic"))
...
norm_5e_4_mse_10sim <- read.csv("results/norm_5e-4_mse-change_10sim.csv")
results_mse2 <- data.frame(Scenario=c(1:24),n_samples = c(rep(c("30,000","300,000"),12)), h2 = norm_5e_4_mse_10sim$h2[1:24], prop_effect = norm_5e_4_mse_10sim$prop_effect[1:24], S= norm_5e_4_mse_10sim$S[1:24], EB = round(norm_5e_4_mse_10sim$results[1:24],4), FIQT = round(norm_5e_4_mse_10sim$results[(1+24):(24+24)],4), BR = round(norm_5e_4_mse_10sim$results[(1+2*24):(24+2*24)],4), cl1 = round(norm_5e_4_mse_10sim$results[(1+2*24):(24+2*24)],4), cl2 = round(norm_5e_4_mse_10sim$results[(1+2*24):(24+2*24)],4), cl3 = round(norm_5e_4_mse_10sim$results[(1+2*24):(24+2*24)],4))
...
full_width = FALSE,position="center") %>%
  ...
  column_spec(5,background="#E8F6F3") %>%
...
```{r,echo=FALSE, fig.show="hold", out.width="50%",fig.height=3.6,eval=FALSE}
...
results_nsig <- data.frame(Scenario=c(1:24),n_samples=c(rep(c("30,000","300,000"),12)),results_nsig_5e_8[3:5], nsig_5e_8=round(results_nsig_5e_8$n_sig,2), nsig_5e_8_sd=round(results_nsig_5e_8$n_sig_sd,3), pb58 = round(results_nsig_5e_8$prop_bias,4), pb58sd=round(results_nsig_5e_8$prop_bias_sd,4))
...
full_width = FALSE,position="center") %>%
  ...
  column_spec(5,background="#FDEDEC") %>%
  column_spec(7, background = "#F5F5F5", italic=TRUE) %>%
  column_spec(9, background = "#F5F5F5", italic=TRUE) %>%
  scroll_box(width = "70%", height = "300px")
```
...
## Scenario 11
ss <- simulate_ss_skew(H=0.8,Pi=0.01,nid=30000,sc=0)
out <- simulate_est(ss)
out$z <- out$beta/out$se
out$bias <- out$beta - ss$true_beta
ggplot(out,aes(x=z,y=bias)) + geom_point(size=1) + xlab("z") +
...
## Scenario 12
ss <- simulate_ss_skew(H=0.8,Pi=0.01,nid=300000,sc=0)
out <- simulate_est(ss)
out$z <- out$beta/out$se
out$bias <- out$beta - ss$true_beta
ggplot(out,aes(x=z,y=bias)) + geom_point(size=1) + xlab("z") +
...
skew_5e_8_flb_10sim <- read.csv("results/skew_5e-8_flb_10sim.csv")
results_flb_skew <- data.frame(Scenario=c(1:24),n_samples = c(rep(c("30,000","300,000"),12)), h2 = skew_5e_8_flb_10sim$h2[1:24], prop_effect = skew_5e_8_flb_10sim$prop_effect[1:24], S= skew_5e_8_flb_10sim$S[1:24], EB = round(skew_5e_8_flb_10sim$results[1:24],4), FIQT = round(skew_5e_8_flb_10sim$results[(1+24):(24+24)],4), BR = round(skew_5e_8_flb_10sim$results[(1+2*24):(24+2*24)],4), cl1 = round(skew_5e_8_flb_10sim$results[(1+3*24):(24+3*24)],4), cl2 = round(skew_5e_8_flb_10sim$results[(1+4*24):(24+4*24)],4), cl3 = round(skew_5e_8_flb_10sim$results[(1+5*24):(24+5*24)],4))
...
full_width = FALSE,position="center") %>%
  ...
  column_spec(5,background="#EBEDEF") %>%
  scroll_box(width = "70%", height = "300px")
...
## plot results
skew_5e_8_flb_10sim$scenario <- c(rep(c(1:24),6))
skew_5e_8_flb_10sim$scenario <- factor(skew_5e_8_flb_10sim$scenario)

par(mar = c(4, 4, .1, .1))


data_negS <- skew_5e_8_flb_10sim[which(skew_5e_8_flb_10sim$S==-1),]
data_negSa <- data_negS[data_negS$scenario == 1 | data_negS$scenario == 2 |data_negS$scenario == 3 |data_negS$scenario == 4,]
ggplot(data_negSa,aes(x=scenario,y=results,colour=method)) + geom_point(position=position_dodge(0.35),size=4.5,aes(shape=method, color=method)) + ggtitle("Scenarios 1 - 4", subtitle="S=-1   prop_effect=0.01")  + scale_shape_manual(values=c(6,18,10,20,15,17)) + scale_color_manual(values=c(col[1],col[2],col[8],col[4],col[5],col[6]))  +
...
data_neutralS <- skew_5e_8_flb_10sim[which(skew_5e_8_flb_10sim$S==0),]
data_neutralSa <- data_neutralS[data_neutralS$scenario == 9 | data_neutralS$scenario == 10 |data_neutralS$scenario == 11 |data_neutralS$scenario == 12,]
ggplot(data_neutralSa,aes(x=scenario,y=results,colour=method)) + geom_point(position=position_dodge(0.35),size=4.5,aes(shape=method, color=method)) + scale_shape_manual(values=c(6,18,10,20,15,17)) + scale_color_manual(values=c(col[1],col[2],col[8],col[4],col[5],col[6])) + xlab("") + ggtitle("Scenarios 9 - 12", subtitle="S=0   prop_effect=0.01") +
  ylab(expression(paste("Fraction of sig. SNPs", italic(" less "), "biased"))) + theme_classic() + geom_errorbar(aes(ymin=results-res_error, ymax=results+res_error), width=.25,position=position_dodge(0.35)) + geom_hline(yintercept=0.5, colour="black") +  theme(axis.text.x = element_text(face = "bold",size=rel(1.25)),legend.title = element_blank(),legend.box.background = element_rect(colour = "black"),legend.spacing.y = unit(0, "mm"), legend.background=element_blank(), legend.text = element_text(size=10),plot.title = element_text(hjust = 0.5, face="bold", colour='#1B2631'),plot.subtitle = element_text(hjust = 0.5, face="italic"))
...
data_posS <- skew_5e_8_flb_10sim[which(skew_5e_8_flb_10sim$S==1),]
data_posSa <- data_posS[data_posS$scenario == 17 | data_posS$scenario == 18 |data_posS$scenario == 19 |data_posS$scenario == 20,]
ggplot(data_posSa,aes(x=scenario,y=results,colour=method)) + geom_point(position=position_dodge(0.35),size=4.5,aes(shape=method, color=method)) + ggtitle("Scenarios 17 - 20", subtitle="S=1   prop_effect=0.01") + scale_shape_manual(values=c(6,18,10,20,15,17)) + scale_color_manual(values=c(col[1],col[2],col[8],col[4],col[5],col[6])) + xlab("") +
  ylab(expression(paste("Fraction of sig. SNPs", italic(" less "), "biased"))) + theme_classic() + geom_errorbar(aes(ymin=results-res_error, ymax=results+res_error), width=.25,position=position_dodge(0.35)) + geom_hline(yintercept=0.5, colour="black") +  theme(axis.text.x = element_text(face = "bold",size=rel(1.25)),legend.title = element_blank(),legend.box.background = element_rect(colour = "black"),legend.spacing.y = unit(0, "mm"), legend.background=element_blank(), legend.text = element_text(size=10),plot.title = element_text(hjust = 0.5, face="bold", colour='#1B2631'),plot.subtitle = element_text(hjust = 0.5, face="italic"))
