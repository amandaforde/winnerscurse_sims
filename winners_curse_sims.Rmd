...
results_flb <- data.frame(Scenario=c(1:24),n_samples = c(rep(c("30,000","300,000"),12)), h2 = norm_5e_8_20sim$h2[1:24], prop_effect = norm_5e_8_20sim$prop_effect[1:24], S= norm_5e_8_20sim$S[1:24], EB = round(norm_5e_8_20sim$flb[1:24],4), EBscam = round(norm_5e_8_20sim$flb[(1+24):(24+24)],4), FIQT = round(norm_5e_8_20sim$flb[(1+2*24):(24+2*24)],4), BR = round(norm_5e_8_20sim$flb[(1+3*24):(24+3*24)],4), cl1 = round(norm_5e_8_20sim$flb[(1+4*24):(24+4*24)],4), cl2 = round(norm_5e_8_20sim$flb[(1+5*24):(24+5*24)],4), cl3 = round(norm_5e_8_20sim$flb[(1+6*24):(24+6*24)],4), rep = round(norm_5e_8_20sim$flb[(1+7*24):(24+7*24)],4))
...
## plot results
norm_5e_8_20sim$scenario <- c(rep(c(1:24),8))
...
ggplot(data_negSa,aes(x=scenario,y=flb,colour=method)) + geom_point(position=position_dodge(0.4),size=4.5,aes(shape=method, color=method)) + ggtitle("Scenarios 1 - 4", subtitle="S=-1   prop_effect=0.01")  + scale_shape_manual(values=c(6,18,10,20,15,15,17,16)) + scale_color_manual(values=c(col[1],col[2],col[8],col[4],col[5],'darkred',col[6],col[3]))  +
...
ggplot(data_negSb,aes(x=scenario,y=flb,colour=method)) + geom_point(position=position_dodge(0.4),size=4.5,aes(shape=method, color=method)) + ggtitle("Scenarios 5 - 8", subtitle="S=-1   prop_effect=0.001") + scale_shape_manual(values=c(6,18,10,20,15,15,17,16)) + scale_color_manual(values=c(col[1],col[2],col[8],col[4],col[5],'darkred',col[6],col[3])) + xlab("") +
...
ggplot(data_posSa,aes(x=scenario,y=flb,colour=method)) + geom_point(position=position_dodge(0.4),size=4.5,aes(shape=method, color=method)) + ggtitle("Scenarios 17 - 20", subtitle="S=1   prop_effect=0.01") + scale_shape_manual(values=c(6,18,10,20,15,15,17,16)) + scale_color_manual(values=c(col[1],col[2],col[8],col[4],col[5],'darkred',col[6],col[3])) + xlab("") +
  ylab(expression(paste("Fraction of", italic(" improved "), "sig. SNPs"))) + theme_classic() + geom_errorbar(aes(ymin=flb-flb_error, ymax=flb+flb_error), width=.25,position=position_dodge(0.4)) + geom_hline(yintercept=0.5, colour="black") +  theme(axis.text.x = element_text(face = "bold",size=rel(1.25)),legend.title = element_blank(),legend.box.background = element_rect(colour = "black"),legend.spacing.y = unit(0, "mm"), legend.background=element_blank(), legend.text = element_text(size=10),plot.title = element_text(hjust = 0.5, face="bold", colour='#154360'),plot.subtitle = element_text(hjust = 0.5, face="italic"))


data_posSb <- data_posS[data_posS$scenario == 21 | data_posS$scenario == 22 |data_posS$scenario == 23 |data_posS$scenario == 24,]
ggplot(data_posSb,aes(x=scenario,y=flb,colour=method)) + geom_point(position=position_dodge(0.4),size=4.5,aes(shape=method, color=method)) + ggtitle("Scenarios 21 - 24", subtitle="S=1   prop_effect=0.001") + scale_shape_manual(values=c(6,18,10,20,15,15,17,16)) + scale_color_manual(values=c(col[1],col[2],col[8],col[4],col[5],'darkred',col[6],col[3])) + xlab("") +
  ylab(expression(paste("Fraction of", italic(" improved "), "sig. SNPs"))) + theme_classic() + geom_errorbar(aes(ymin=flb-flb_error, ymax=flb+flb_error), width=.25,position=position_dodge(0.4)) + geom_hline(yintercept=0.5, colour="black") +  theme(axis.text.x = element_text(face = "bold",size=rel(1.25)),legend.title = element_blank(),legend.box.background = element_rect(colour = "black"),legend.spacing.y = unit(0, "mm"), legend.background=element_blank(), legend.text = element_text(size=10),plot.title = element_text(hjust = 0.5, face="bold", colour='#154360'),plot.subtitle = element_text(hjust = 0.5, face="italic"))
```


```{r, echo=FALSE}
data_neutralS$n_samples <- c(rep(c("30,000","300,000"),32))
ggplot(data_neutralS,aes(x=n_samples,y=flb,colour=method)) + geom_point(position=position_dodge(0.4),size=3.5,aes(shape=method, color=method)) + facet_grid(h2~prop_effect,labeller=label_both) + scale_shape_manual(values=c(6,18,10,20,15,15,17,16)) + scale_color_manual(values=c(col[1],col[2],col[8],col[4],col[5],'darkred',col[6],col[3])) + xlab("Sample size") + 
...
results_mse <- data.frame(Scenario=c(1:24),n_samples = c(rep(c("30,000","300,000"),12)), h2 = norm_5e_8_20sim$h2[1:24], prop_effect = norm_5e_8_20sim$prop_effect[1:24], S= norm_5e_8_20sim$S[1:24], EB = round(norm_5e_8_20sim$mse[1:24],6), EBscam = round(norm_5e_8_20sim$mse[(1+24):(24+24)],6), FIQT = round(norm_5e_8_20sim$mse[(1+2*24):(24+2*24)],6), BR = round(norm_5e_8_20sim$mse[(1+3*24):(24+3*24)],6), cl1 = round(norm_5e_8_20sim$mse[(1+4*24):(24+4*24)],6), cl2 = round(norm_5e_8_20sim$mse[(1+5*24):(24+5*24)],6), cl3 = round(norm_5e_8_20sim$mse[(1+6*24):(24+6*24)],6), rep = round(norm_5e_8_20sim$mse[(1+7*24):(24+7*24)],6))
...
results_rel_mse <- data.frame(Scenario=c(1:24),n_samples = c(rep(c("30,000","300,000"),12)), h2 = norm_5e_8_20sim$h2[1:24], prop_effect = norm_5e_8_20sim$prop_effect[1:24], S= norm_5e_8_20sim$S[1:24], EB = round(norm_5e_8_20sim$rel_mse[1:24],4), EBscam = round(norm_5e_8_20sim$rel_mse[(1+24):(24+24)],4), FIQT = round(norm_5e_8_20sim$rel_mse[(1+2*24):(24+2*24)],4), BR = round(norm_5e_8_20sim$rel_mse[(1+3*24):(24+3*24)],4), cl1 = round(norm_5e_8_20sim$rel_mse[(1+4*24):(24+4*24)],4), cl2 = round(norm_5e_8_20sim$rel_mse[(1+5*24):(24+5*24)],4), cl3 = round(norm_5e_8_20sim$rel_mse[(1+6*24):(24+6*24)],4), rep = round(norm_5e_8_20sim$rel_mse[(1+7*24):(24+7*24)],4))
...
results_flb <- data.frame(Scenario=c(1:24),n_samples = c(rep(c("30,000","300,000"),12)), h2 = norm_5e_4_10sim$h2[1:24], prop_effect = norm_5e_4_10sim$prop_effect[1:24], S= norm_5e_4_10sim$S[1:24], EB = round(norm_5e_4_10sim$flb[1:24],4), EBscam = round(norm_5e_4_10sim$flb[(1+24):(24+24)],4), FIQT = round(norm_5e_4_10sim$flb[(1+2*24):(24+2*24)],4), BR = round(norm_5e_4_10sim$flb[(1+3*24):(24+3*24)],4), cl1 = round(norm_5e_4_10sim$flb[(1+4*24):(24+4*24)],4), cl2 = round(norm_5e_4_10sim$flb[(1+5*24):(24+5*24)],4), cl3 = round(norm_5e_4_10sim$flb[(1+6*24):(24+6*24)],4), rep = round(norm_5e_4_10sim$flb[(1+7*24):(24+7*24)],4))
...
## plot results
norm_5e_4_10sim$scenario <- c(rep(c(1:24),8))
...
results_mse <- data.frame(Scenario=c(1:24),n_samples = c(rep(c("30,000","300,000"),12)), h2 = norm_5e_4_10sim$h2[1:24], prop_effect = norm_5e_4_10sim$prop_effect[1:24], S= norm_5e_4_10sim$S[1:24], EB = round(norm_5e_4_10sim$mse[1:24],6), EBscam = round(norm_5e_4_10sim$mse[(1+24):(24+24)],6), FIQT = round(norm_5e_4_10sim$mse[(1+2*24):(24+2*24)],6), BR = round(norm_5e_4_10sim$mse[(1+3*24):(24+3*24)],6), cl1 = round(norm_5e_4_10sim$mse[(1+4*24):(24+4*24)],6), cl2 = round(norm_5e_4_10sim$mse[(1+5*24):(24+5*24)],6), cl3 = round(norm_5e_4_10sim$mse[(1+6*24):(24+6*24)],6), rep = round(norm_5e_4_10sim$mse[(1+7*24):(24+7*24)],6))
...
results_rel_mse <- data.frame(Scenario=c(1:24),n_samples = c(rep(c("30,000","300,000"),12)), h2 = norm_5e_4_10sim$h2[1:24], prop_effect = norm_5e_4_10sim$prop_effect[1:24], S= norm_5e_4_10sim$S[1:24], EB = round(norm_5e_4_10sim$rel_mse[1:24],4), EBscam = round(norm_5e_4_10sim$rel_mse[(1+24):(24+24)],4), FIQT = round(norm_5e_4_10sim$rel_mse[(1+2*24):(24+2*24)],4), BR = round(norm_5e_4_10sim$rel_mse[(1+3*24):(24+3*24)],4), cl1 = round(norm_5e_4_10sim$rel_mse[(1+4*24):(24+4*24)],4), cl2 = round(norm_5e_4_10sim$rel_mse[(1+5*24):(24+5*24)],4), cl3 = round(norm_5e_4_10sim$rel_mse[(1+6*24):(24+6*24)],4), rep = round(norm_5e_4_10sim$rel_mse[(1+7*24):(24+7*24)],4))
...
skew_5e_8_10sim <- read.csv("results/bimod_5e-8_20sim.csv")
results_flb_skew <- data.frame(Scenario=c(1:24),n_samples = c(rep(c("30,000","300,000"),12)), h2 = skew_5e_8_10sim$h2[1:24], prop_effect = skew_5e_8_10sim$prop_effect[1:24], S= skew_5e_8_10sim$S[1:24], EB = round(skew_5e_8_10sim$flb[1:24],4), EBscam = round(skew_5e_8_10sim$flb[(1+24):(24+24)],4), FIQT = round(skew_5e_8_10sim$flb[(1+2*24):(24+2*24)],4), BR = round(skew_5e_8_10sim$flb[(1+3*24):(24+3*24)],4), cl1 = round(skew_5e_8_10sim$flb[(1+4*24):(24+4*24)],4), cl2 = round(skew_5e_8_10sim$flb[(1+5*24):(24+5*24)],4), cl3 = round(skew_5e_8_10sim$flb[(1+6*24):(24+6*24)],4),  rep = round(skew_5e_8_10sim$flb[(1+7*24):(24+7*24)],4))
...
## plot results
skew_5e_8_10sim$scenario <- c(rep(c(1:24),8))
...
results_mse_skew <- data.frame(Scenario=c(1:24),n_samples = c(rep(c("30,000","300,000"),12)), h2 = skew_5e_8_10sim$h2[1:24], prop_effect = skew_5e_8_10sim$prop_effect[1:24], S= skew_5e_8_10sim$S[1:24], EB = round(skew_5e_8_10sim$mse[1:24],6), EBscam = round(skew_5e_8_10sim$mse[(1+24):(24+24)],6), FIQT = round(skew_5e_8_10sim$mse[(1+2*24):(24+2*24)],6), BR = round(skew_5e_8_10sim$mse[(1+3*24):(24+3*24)],6), cl1 = round(skew_5e_8_10sim$mse[(1+4*24):(24+4*24)],6), cl2 = round(skew_5e_8_10sim$mse[(1+5*24):(24+5*24)],6), cl3 = round(skew_5e_8_10sim$mse[(1+6*24):(24+6*24)],6), rep = round(skew_5e_8_10sim$mse[(1+7*24):(24+7*24)],6))
...
results_rel_mse_skew <- data.frame(Scenario=c(1:24),n_samples = c(rep(c("30,000","300,000"),12)), h2 = skew_5e_8_10sim$h2[1:24], prop_effect = skew_5e_8_10sim$prop_effect[1:24], S= skew_5e_8_10sim$S[1:24], EB = round(skew_5e_8_10sim$rel_mse[1:24],4), EBscam = round(skew_5e_8_10sim$rel_mse[(1+24):(24+24)],4), FIQT = round(skew_5e_8_10sim$rel_mse[(1+2*24):(24+2*24)],4), BR = round(skew_5e_8_10sim$rel_mse[(1+3*24):(24+3*24)],4), cl1 = round(skew_5e_8_10sim$rel_mse[(1+4*24):(24+4*24)],4), cl2 = round(skew_5e_8_10sim$rel_mse[(1+5*24):(24+5*24)],4), cl3 = round(skew_5e_8_10sim$rel_mse[(1+6*24):(24+6*24)],4), rep = round(skew_5e_8_10sim$rel_mse[(1+7*24):(24+7*24)],4))
...
The *mean* relative change in average MSE over all significant SNPs across the 24 scenarios is obtained for each method: 
```{r, echo=FALSE}
ranking <- results_rel_mse_skew[,6:13]
summary2 <- apply(ranking,2,mean,na.rm=TRUE)
summary2
```
...
skew_5e_8_10sim <- read.csv("results/skew_exp_5e-8_20sim.csv")
results_flb_skew <- data.frame(Scenario=c(1:24),n_samples = c(rep(c("30,000","300,000"),12)), h2 = skew_5e_8_10sim$h2[1:24], prop_effect = skew_5e_8_10sim$prop_effect[1:24], S= skew_5e_8_10sim$S[1:24], EB = round(skew_5e_8_10sim$flb[1:24],4), EBscam = round(skew_5e_8_10sim$flb[(1+24):(24+24)],4), FIQT = round(skew_5e_8_10sim$flb[(1+2*24):(24+2*24)],4), BR = round(skew_5e_8_10sim$flb[(1+3*24):(24+3*24)],4), cl1 = round(skew_5e_8_10sim$flb[(1+4*24):(24+4*24)],4), cl2 = round(skew_5e_8_10sim$flb[(1+5*24):(24+5*24)],4), cl3 = round(skew_5e_8_10sim$flb[(1+6*24):(24+6*24)],4), rep = round(skew_5e_8_10sim$flb[(1+7*24):(24+7*24)],4))
...
Summary of results for `rel_mse` contained in `skew_exp_5e-8_20sim.csv`:
...
We first perform similar simulations to as those in previous sections with a normal effect size distribution, computing the *mean* relative change in average MSE over all significant SNPs for both the empirical Bayes method and the true Bayes rule which we have described here. 
