...
norm_5e_8_10sim <- read.csv("results/norm_5e-8_10sim.csv")
results_flb <- data.frame(Scenario=c(1:24),n_samples = c(rep(c("30,000","300,000"),12)), h2 = norm_5e_8_10sim$h2[1:24], prop_effect = norm_5e_8_10sim$prop_effect[1:24], S= norm_5e_8_10sim$S[1:24], EB = round(norm_5e_8_10sim$flb[1:24],4), FIQT = round(norm_5e_8_10sim$flb[(1+24):(24+24)],4), BR = round(norm_5e_8_10sim$flb[(1+2*24):(24+2*24)],4), cl1 = round(norm_5e_8_10sim$flb[(1+3*24):(24+3*24)],4), cl2 = round(norm_5e_8_10sim$flb[(1+4*24):(24+4*24)],4), cl3 = round(norm_5e_8_10sim$flb[(1+5*24):(24+5*24)],4))
...
## plot results
norm_5e_8_10sim$scenario <- c(rep(c(1:24),6))
norm_5e_8_10sim$scenario <- factor(norm_5e_8_10sim$scenario)

par(mar = c(4, 4, .1, .1))


data_negS <- norm_5e_8_10sim[which(norm_5e_8_10sim$S==-1),]
...
ggplot(data_negSb,aes(x=scenario,y=flb,colour=method)) + geom_point(position=position_dodge(0.35),size=4.5,aes(shape=method, color=method)) + ggtitle("Scenarios 5 - 8", subtitle="S=-1   prop_effect=0.001") + scale_shape_manual(values=c(6,18,10,20,15,17)) + scale_color_manual(values=c(col[1],col[2],col[8],col[4],col[5],col[6])) + xlab("") +
  ylab(expression(paste("Fraction of sig. SNPs", italic(" less "), "biased"))) + theme_classic() + geom_errorbar(aes(ymin=flb-flb_error, ymax=flb+flb_error), width=.25,position=position_dodge(0.35)) + geom_hline(yintercept=0.5, colour="black") + theme(axis.text.x = element_text(face ="bold",size=rel(1.25)),legend.title = element_blank(),legend.box.background = element_rect(colour = "black"),legend.spacing.y = unit(0, "mm"), legend.background=element_blank(), legend.text = element_text(size=10),plot.title = element_text(hjust = 0.5, face="bold", colour='#154360'),plot.subtitle = element_text(hjust = 0.5, face="italic"))


data_neutralS <- norm_5e_8_10sim[which(norm_5e_8_10sim$S==0),]
...
data_posS <- norm_5e_8_10sim[which(norm_5e_8_10sim$S==1),]
...
results_mse <- data.frame(Scenario=c(1:24),n_samples = c(rep(c("30,000","300,000"),12)), h2 = norm_5e_8_10sim$h2[1:24], prop_effect = norm_5e_8_10sim$prop_effect[1:24], S= norm_5e_8_10sim$S[1:24], EB = round(norm_5e_8_10sim$mse[1:24],6), FIQT = round(norm_5e_8_10sim$mse[(1+24):(24+24)],6), BR = round(norm_5e_8_10sim$mse[(1+2*24):(24+2*24)],6), cl1 = round(norm_5e_8_10sim$mse[(1+3*24):(24+3*24)],6), cl2 = round(norm_5e_8_10sim$mse[(1+4*24):(24+4*24)],6), cl3 = round(norm_5e_8_10sim$mse[(1+5*24):(24+5*24)],6))
...
results_rel_mse <- data.frame(Scenario=c(1:24),n_samples = c(rep(c("30,000","300,000"),12)), h2 = norm_5e_8_10sim$h2[1:24], prop_effect = norm_5e_8_10sim$prop_effect[1:24], S= norm_5e_8_10sim$S[1:24], EB = round(norm_5e_8_10sim$rel_mse[1:24],4), FIQT = round(norm_5e_8_10sim$rel_mse[(1+24):(24+24)],4), BR = round(norm_5e_8_10sim$rel_mse[(1+2*24):(24+2*24)],4), cl1 = round(norm_5e_8_10sim$rel_mse[(1+3*24):(24+3*24)],4), cl2 = round(norm_5e_8_10sim$rel_mse[(1+4*24):(24+4*24)],4), cl3 = round(norm_5e_8_10sim$rel_mse[(1+5*24):(24+5*24)],4))
...
ggplot(data_negSb,aes(x=scenario,y=rel_mse,colour=method)) + geom_point(position=position_dodge(0.35),size=4.5,aes(shape=method, color=method)) + ggtitle("Scenarios 5 - 8", subtitle="S=-1   prop_effect=0.001") + scale_shape_manual(values=c(6,18,10,20,15,17)) + scale_color_manual(values=c(col[1],col[2],col[8],col[4],col[5],col[6])) + xlab("") +
  ylab(expression(paste("%", italic(" change "), "in MSE of sig. SNPs"))) + theme_classic() + geom_errorbar(aes(ymin=rel_mse-rel_mse_error, ymax=rel_mse+rel_mse_error), width=.25,position=position_dodge(0.35)) + geom_hline(yintercept=0, colour="black") + theme(axis.text.x = element_text(face ="bold",size=rel(1.25)),legend.title = element_blank(),legend.box.background = element_rect(colour = "black"),legend.spacing.y = unit(0, "mm"), legend.background=element_blank(), legend.text = element_text(size=10),plot.title = element_text(hjust = 0.5, face="bold", colour='#0B5345'),plot.subtitle = element_text(hjust = 0.5, face="italic"))
...
skew_5e_8_10sim <- read.csv("results/skew_5e-8_10sim.csv")
