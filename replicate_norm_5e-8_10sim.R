...
run_sim <- function(n_samples, h2, prop_effect, S,sim)
{
  ...
  return(c(flb_EB,mse_EB,rel_mse_EB,flb_rep,mse_rep,rel_mse_rep,flb_UMVCUE,mse_UMVCUE,rel_mse_UMVCUE,flb_com,mse_com,rel_mse_com,flb_MLE,mse_MLE,rel_mse_MLE,flb_MSE,mse_MSE,rel_mse_MSE,flb_joint,mse_joint,rel_mse_joint,flb_joint_sp,mse_joint_sp,rel_mse_joint_sp))
}
...
## Combine all results:
results_all <- rbind(ave_res_EB,ave_res_rep,ave_res_UMVCUE,ave_res_com,ave_res_MLE,ave_res_MSE,ave_res_joint,ave_res_joint_sp)
results_all$method <- c(rep("EB",(nrow(sim_params)/tot_sim)),rep("rep",(nrow(sim_params)/tot_sim)),rep("UMVCUE",(nrow(sim_params)/tot_sim)),rep("cl1_com",(nrow(sim_params)/tot_sim)),rep("cl2_MLE",(nrow(sim_params)/tot_sim)),rep("cl3_MSE",(nrow(sim_params)/tot_sim)),rep("MSE_min",(nrow(sim_params)/tot_sim)), rep("MSE_min_sp",(nrow(sim_params)/tot_sim)))
