...
data_neutralS <- results_nsig_5e_8_all[which(results_nsig_5e_8_all$S==0),]
data_neutralS$scenario <- c(rep("Scenario 09",10), rep("Scenario 10",10), rep("Scenario 11",10), rep("Scenario 12",10), rep("Scenario 13",10), rep("Scenario 14",10), rep("Scenario 15",10), rep("Scenario 16",10))
