...
results_nsig_5e_8 <- read.csv("C:/Users/GenDataSci025/winnerscurse_sims/results/norm_nsig_prop_bias_5e-8.csv")
results_nsig_5e_4 <- read.csv("C:/Users/GenDataSci025/winnerscurse_sims/results/norm_nsig_prop_bias_5e-4.csv")
...
results_nsig_5e_8_all <- read.csv("C:/Users/GenDataSci025/winnerscurse_sims/results/norm_nsig_prop_bias_5e_8_all.csv")
...
norm_5e_8_100sim <- read.csv("C:/Users/GenDataSci025/winnerscurse_sims/results/norm_5e-8_100sim_ave.csv")
...
norm_5e_8_100sim_all <- read.csv("C:/Users/GenDataSci025/winnerscurse_sims/results/norm_5e-8_100sim_all.csv")
...
```{r,echo=FALSE}
norm_5e_8_100sim <- read.csv("C:/Users/GenDataSci025/winnerscurse_sims/results/norm_5e-4_100sim_ave.csv")
results_mse <- data.frame(Scenario=c(1:24),n_samples = c(rep(c("30,000","300,000"),12)), h2 = norm_5e_8_100sim$h2[1:24], prop_effect = norm_5e_8_100sim$prop_effect[1:24], S= norm_5e_8_100sim$S[1:24], EB = round(norm_5e_8_100sim$mse[1:24],6), EB_df = round(norm_5e_8_100sim$mse[(1+24):(24+24)],6), EB_scam = round(norm_5e_8_100sim$mse[(1+2*24):(24+2*24)],6), EB_gam_po = round(norm_5e_8_100sim$mse[(1+3*24):(24+3*24)],6), EB_gam_nb = round(norm_5e_8_100sim$mse[(1+4*24):(24+4*24)],6), FIQT = round(norm_5e_8_100sim$mse[(1+5*24):(24+5*24)],6), boot = round(norm_5e_8_100sim$mse[(1+6*24):(24+6*24)],6), cl1 = round(norm_5e_8_100sim$mse[(1+7*24):(24+7*24)],6), cl2 = round(norm_5e_8_100sim$mse[(1+8*24):(24+8*24)],6), cl3 = round(norm_5e_8_100sim$mse[(1+9*24):(24+9*24)],6), rep = round(norm_5e_8_100sim$mse[(1+10*24):(24+10*24)],6))
...
```{r,echo=FALSE}
## plotting full data set! 
norm_5e_4_100sim_all <- read.csv("C:/Users/GenDataSci025/winnerscurse_sims/results/norm_5e-4_100sim_all.csv")
...
bim_5e_8_10sim <- read.csv("C:/Users/GenDataSci025/winnerscurse_sims/results/bim_5e-8_10sim_ave.csv")
...
bim_5e_8_100sim_all <- read.csv("C:/Users/GenDataSci025/winnerscurse_sims/results/bim_5e-8_10sim_all.csv")
...
bim_5e_4_10sim <- read.csv("C:/Users/GenDataSci025/winnerscurse_sims/results/bim_5e-4_10sim_ave.csv")
...
bim_5e_4_100sim_all <- read.csv("C:/Users/GenDataSci025/winnerscurse_sims/results/bim_5e-4_10sim_all.csv")
...
skew_5e_8_10sim <- read.csv("C:/Users/GenDataSci025/winnerscurse_sims/results/skew_5e-8_10sim_ave.csv")
...
skew_5e_8_100sim_all <- read.csv("C:/Users/GenDataSci025/winnerscurse_sims/results/skew_5e-8_10sim_all.csv")
...
skew_5e_4_10sim <- read.csv("C:/Users/GenDataSci025/winnerscurse_sims/results/skew_5e-4_10sim_ave.csv")
...
skew_5e_4_100sim_all <- read.csv("C:/Users/GenDataSci025/winnerscurse_sims/results/skew_5e-4_10sim_all.csv")
...
bin_5e_8_10sim <- read.csv("C:/Users/GenDataSci025/winnerscurse_sims/results/bin_5e-8_10sim_ave.csv")
...
bin_5e_8_10sim_all <- read.csv("C:/Users/GenDataSci025/winnerscurse_sims/results/bin_5e-8_10sim_all.csv")
...
bin_5e_4_10sim <- read.csv("C:/Users/GenDataSci025/winnerscurse_sims/results/bin_5e-4_10sim_ave.csv")
...
bin_5e_4_100sim_all <- read.csv("C:/Users/GenDataSci025/winnerscurse_sims/results/bin_5e-4_10sim_all.csv")
...
norm_5e_8_100sim <- read.csv("C:/Users/GenDataSci025/winnerscurse_sims/results/norm_5e-8_100sim_LD_ave.csv")
...
## plotting full data set! 
norm_5e_8_100sim_all <- read.csv("C:/Users/GenDataSci025/winnerscurse_sims/results/norm_5e-8_100sim_LD_all.csv")
...
```{r,echo=FALSE}
norm_5e_4_100sim <- read.csv("C:/Users/GenDataSci025/winnerscurse_sims/results/norm_5e-4_100sim_LD_ave.csv")
...
```{r,echo=FALSE}
## plotting full data set! 
norm_5e_4_100sim_all <- read.csv("C:/Users/GenDataSci025/winnerscurse_sims/results/norm_5e-4_100sim_LD_all.csv")

norm_5e_4_100sim_all$scenario <- c(rep(c(1:8),10))
norm_5e_4_100sim_all$scenario <- factor(norm_5e_4_100sim_all$scenario)
